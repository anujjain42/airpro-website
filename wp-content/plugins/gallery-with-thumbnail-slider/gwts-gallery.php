...
<div class="mainopt">
	...
	<label for="gwts_gwl_lightbx_switcher"><?php esc_html_e( 'Enable Caption: ', 'gallery-with-thumbnail-slider' ); ?></label>
	 <label class="switch">
	...
	<!-- Enable Caption -->
	<div class="gwts-settings-opts">
	<label for="gwts_gwl_lightbx_switcher"><?php esc_html_e( 'Enable Alt Text: ', 'gallery-with-thumbnail-slider' ); ?></label>
	 <label class="switch">
	...
	<div class="gwts-settings-opts">
	<label for="gwts_gwl_lightbx_switcher"><?php esc_html_e( 'Enable Auto Slide: ', 'gallery-with-thumbnail-slider' ); ?></label>
	 <label class="switch">
	...
	<!-- Enable loop slider -->
	<div class="gwts-settings-opts">
	<label for="gwts_gwl_lightbx_switcher"><?php esc_html_e( 'Enable Loop Slide: ', 'gallery-with-thumbnail-slider' ); ?></label>
	 <label class="switch">
